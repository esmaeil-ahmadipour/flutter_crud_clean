...
abstract class BlocAdditionalState<E, S> extends Bloc<E, S> {
  BlocAdditionalState(S initialState) : super(initialState);

  BlocProcessState _state = BlocProcessState.idle;

  BlocProcessState get blocProcessState => _state;

  Stream<S> runningProcess(Stream<S> Function() process) async* {
